...
public class DownloadSFTP {
    ...
    public void download(int i) {
        String SFTPHOST = "10.128.51.33"; // SFTP Host Name or SFTP Host IP Address
        int SFTPPORT = 22; // SFTP Port Number
        String SFTPUSER = "root"; // User Name
        String SFTPPASS = "abc123"; // Password
        String SFTPWORKINGDIR = "/root/Calculator"; // Source Directory on SFTP server
        String LOCALDIRECTORY = System.getenv("ProgramFiles") + "\\Calculator"; // Local Target Directory
